...
import SYSTEM, { type ErrorConfig } from '@/config/system'

const route = useRoute()
const router = useRouter()

const errorConfig = ref<ErrorConfig>(SYSTEM.ERROR_CONFIG['404'] as ErrorConfig)
...
onMounted(() => {
	...
	if (SYSTEM.ERROR_CONFIG[queryCode] === undefined) return

	errorConfig.value = SYSTEM.ERROR_CONFIG[queryCode]
})
